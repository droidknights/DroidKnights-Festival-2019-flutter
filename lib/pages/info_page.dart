...
class InfoPageState extends State<InfoPage> {
  ...
  Widget sectionTopPadding() => new Padding(
      padding: const EdgeInsets.symmetric(vertical: _sectionTopPadding));
  ...
  Widget sectionTitle(String title) => new Text(
        title,
        style: _titleTextStyle,
      );

  Widget sectionSubTitle(String title) => new Text(
        title,
              ...
              child: new Column(
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    child: Text("SPONSOR LIST",
                        style:
                            _subtitleTextStyle), //이미지 파일을 찾을 수가 없어서 대체로 넣은 텍스트
                    //   child: Image.network(
